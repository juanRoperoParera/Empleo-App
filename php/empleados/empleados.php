...
<body>
    ...
    <main class="sinmargen">
        ...
        <section class="empleo">
            ...
            <div class="filtros">
                <ul>
                <li><a class='etiqueta' href='empleadosFiltroProyecto.php?proyecto=null'>Sin asignar</a></li>
                    <?php
                        $cif=$_SESSION['nombre'];
            ...
            <?php
                    if(isset($_POST['buscar'])){
                        ...
                        $datos = $con->query("select * from usuario where id in (select id_usuario from trabaja where id_empresa=$idEmpresa) and nombre like '$busquedaFormat'");
                    }else{
                        $datos = $con->query("select * from usuario where id in (select id_usuario from trabaja where id_empresa=$idEmpresa)");
