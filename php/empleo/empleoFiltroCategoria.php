...
<body>
    <header>
        <?php
            ...
            nav();
            $categoriaBuscada = $_GET['categoria'];
        ?>
    </header>
    <main class="sinmargen">
        ...
        <section class="empleo">
            ...
            <div class="filtros">
                    ...
                    <?php
                        ...
                        if(count($oferta) !== ""){
                            for($i = 0; $i<count($oferta); $i++){
                                ...
                                if($nombre !== ""){
                                    if($idCategoria == $categoriaBuscada){
                                        echo "<li class='buscada'><a class='etiqueta' href='empleoFiltroCategoria.php?categoria=$idCategoria'>$nombre</a></li>";
                                    }else{
                ...
                <a class="eliminar" href="empleo.php"> <i class="fa-solid fa-square-xmark"></i> QUITAR FILTRO</a>
            </div>
